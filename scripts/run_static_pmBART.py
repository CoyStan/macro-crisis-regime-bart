...
def main() -> None:
    parser = argparse.ArgumentParser(description="Quick run for static monotone probit BART")
    parser.add_argument("--config", default="configs/experiments/quick_static_pmBART.yaml")
